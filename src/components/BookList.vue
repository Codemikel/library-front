        ...
        <table class="w-full text-left table-auto min-w-max">
            ...
            <tbody>
                <tr v-for="book in books" :key="book.id">
                    ...
                    <td class="block lg:flex justify-around p-4 border-b border-blue-gray-50">
                        <button v-if="book.available" @click="openLoanModal(book)"
